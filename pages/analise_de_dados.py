...
def contexto_conteudo() -> None:
    ...
    with col4:
        st.markdown(
            """
                <div class="conteudo">
                    <h2 class="titulo-2">🗨️ Sobre Lewis Hamilton</h2>
                    <div class="paragrafo">
    ...
    st.markdown(
        """
            <div class="conteudo">
                ...
                <h3 class="titulo-3">👁️‍🗨️ Fonte</h3>
                <div class="paragrafo">
                    <p class="text">
...
def preparacao_conteudo() -> None:
    ...
    with col1:
        st.markdown("""
            <div class="conteudo">
                <h3 class="titulo-3" style="text-align: center;">🏎️ Todas as Corridas (2007-2024)</h3>
            </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown(
        """
            <div class="conteudo">
                ...
                <hr>
                <h3 class="titulo-3">🩹 Tratamento de Dados</h3>
                <div class="paragrafo">
                    <p class="text">
...
def classificacao_conteudo() -> None:
    ...
    st.markdown(
        """
            <div class="conteudo">
                <h2 class="titulo-2">🏷️ Classificação das Variáveis</h2>
                <div class="paragrafo">
                    <p class="text">
...
def analise_conteudo() -> None:
    ...
    st.markdown(
        """
            <div class="conteudo">
                <hr>
                <h3 class="titulo-3">⚔️ Comparação com Companheiros de Equipe</h3>
                <div class="paragrafo">
                    <p class="text">
    ...
    st.markdown(
        """
            <div class="conteudo">
                <div class="paragrafo">
                    <p class="text">
                        Em resumo, a análise comparativa entre Hamilton e seus companheiros de equipe evidencia um padrão claro: mesmo em contextos distintos de regulamento e competitividade do carro, Hamilton mostrou uma consistência estatística superior, com médias geralmente melhores ou pelo menos tão boas quanto as de seus pares. Bottas aparece como o adversário em que a diferença foi mais nítida, enquanto contra Rosberg e Russell a disputa se mostrou mais equilibrada, refletindo momentos de adaptação ou maior competitividade interna. Esses resultados reforçam que, apesar das variações, Hamilton manteve um desempenho sólido e competitivo em diferentes fases da sua carreira.
                    </p>
                </div>
                <hr>
            </div>
...
def conteudo() -> None:
    ...
    with conclusaoTab:
        conclusao_conteudo()
        st.warning("Novas análises estão sendo preparadas... 🔎🛠️")
